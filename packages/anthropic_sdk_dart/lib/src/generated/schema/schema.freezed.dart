...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,model,const DeepCollectionEquality().hash(messages),maxTokens,metadata,const DeepCollectionEquality().hash(stopSequences),system,temperature,toolChoice,const DeepCollectionEquality().hash(tools),topK,topP,stream);
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@_ModelConverter()  Model model,  List<Message> messages, @JsonKey(name: 'max_tokens')  int maxTokens, @JsonKey(includeIfNull: false)  CreateMessageRequestMetadata? metadata, @JsonKey(name: 'stop_sequences', includeIfNull: false)  List<String>? stopSequences, @_CreateMessageRequestSystemConverter()@JsonKey(includeIfNull: false)  CreateMessageRequestSystem? system, @JsonKey(includeIfNull: false)  double? temperature, @JsonKey(name: 'tool_choice', includeIfNull: false)  ToolChoice? toolChoice, @JsonKey(includeIfNull: false)  List<Tool>? tools, @JsonKey(name: 'top_k', includeIfNull: false)  int? topK, @JsonKey(name: 'top_p', includeIfNull: false)  double? topP,  bool stream)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateMessageRequest() when $default != null:
return $default(_that.model,_that.messages,_that.maxTokens,_that.metadata,_that.stopSequences,_that.system,_that.temperature,_that.toolChoice,_that.tools,_that.topK,_that.topP,_that.stream);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,model,const DeepCollectionEquality().hash(_messages),maxTokens,metadata,const DeepCollectionEquality().hash(_stopSequences),system,temperature,toolChoice,const DeepCollectionEquality().hash(_tools),topK,topP,stream);
...
@override $ModelCopyWith<$Res> get model;@override $CreateMessageRequestMetadataCopyWith<$Res>? get metadata;@override $CreateMessageRequestSystemCopyWith<$Res>? get system;@override $ToolChoiceCopyWith<$Res>? get toolChoice;
...
/// @nodoc
mixin _$CharLocation {

/// The type of location reference.
 String get type;/// The text that was cited.
@JsonKey(name: 'cited_text') String get citedText;/// The index of the document being referenced.
@JsonKey(name: 'document_index', includeIfNull: false) int? get documentIndex;
/// Create a copy of CharLocation
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CharLocationCopyWith<CharLocation> get copyWith => _$CharLocationCopyWithImpl<CharLocation>(this as CharLocation, _$identity);

  /// Serializes this CharLocation to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CharLocation&&(identical(other.type, type) || other.type == type)&&(identical(other.citedText, citedText) || other.citedText == citedText)&&(identical(other.documentIndex, documentIndex) || other.documentIndex == documentIndex));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,citedText,documentIndex);

@override
String toString() {
  return 'CharLocation(type: $type, citedText: $citedText, documentIndex: $documentIndex)';
}
...
/// @nodoc
abstract mixin class $CharLocationCopyWith<$Res>  {
  factory $CharLocationCopyWith(CharLocation value, $Res Function(CharLocation) _then) = _$CharLocationCopyWithImpl;
@useResult
$Res call({
 String type,@JsonKey(name: 'cited_text') String citedText,@JsonKey(name: 'document_index', includeIfNull: false) int? documentIndex
});
...
/// @nodoc
class _$CharLocationCopyWithImpl<$Res>
    implements $CharLocationCopyWith<$Res> {
  _$CharLocationCopyWithImpl(this._self, this._then);

  final CharLocation _self;
  final $Res Function(CharLocation) _then;

/// Create a copy of CharLocation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? citedText = null,Object? documentIndex = freezed,}) {
  return _then(_self.copyWith(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as String,citedText: null == citedText ? _self.citedText : citedText // ignore: cast_nullable_to_non_nullable
as String,documentIndex: freezed == documentIndex ? _self.documentIndex : documentIndex // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
/// Adds pattern-matching-related methods to [CharLocation].
extension CharLocationPatterns on CharLocation {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CharLocation value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CharLocation() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CharLocation value)  $default,){
final _that = this;
switch (_that) {
case _CharLocation():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CharLocation value)?  $default,){
final _that = this;
switch (_that) {
case _CharLocation() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String type, @JsonKey(name: 'cited_text')  String citedText, @JsonKey(name: 'document_index', includeIfNull: false)  int? documentIndex)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CharLocation() when $default != null:
return $default(_that.type,_that.citedText,_that.documentIndex);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String type, @JsonKey(name: 'cited_text')  String citedText, @JsonKey(name: 'document_index', includeIfNull: false)  int? documentIndex)  $default,) {final _that = this;
switch (_that) {
case _CharLocation():
return $default(_that.type,_that.citedText,_that.documentIndex);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String type, @JsonKey(name: 'cited_text')  String citedText, @JsonKey(name: 'document_index', includeIfNull: false)  int? documentIndex)?  $default,) {final _that = this;
switch (_that) {
case _CharLocation() when $default != null:
return $default(_that.type,_that.citedText,_that.documentIndex);case _:
  return null;
...
class _CharLocation extends CharLocation {
  const _CharLocation({required this.type, @JsonKey(name: 'cited_text') required this.citedText, @JsonKey(name: 'document_index', includeIfNull: false) this.documentIndex}): super._();
  factory _CharLocation.fromJson(Map<String, dynamic> json) => _$CharLocationFromJson(json);
...
@override@JsonKey(name: 'document_index', includeIfNull: false) final  int? documentIndex;

/// Create a copy of CharLocation
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$CharLocationCopyWith<_CharLocation> get copyWith => __$CharLocationCopyWithImpl<_CharLocation>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CharLocationToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CharLocation&&(identical(other.type, type) || other.type == type)&&(identical(other.citedText, citedText) || other.citedText == citedText)&&(identical(other.documentIndex, documentIndex) || other.documentIndex == documentIndex));
}
...
/// @nodoc
abstract mixin class _$CharLocationCopyWith<$Res> implements $CharLocationCopyWith<$Res> {
  factory _$CharLocationCopyWith(_CharLocation value, $Res Function(_CharLocation) _then) = __$CharLocationCopyWithImpl;
@override @useResult
$Res call({
 String type,@JsonKey(name: 'cited_text') String citedText,@JsonKey(name: 'document_index', includeIfNull: false) int? documentIndex
});
...
/// @nodoc
class __$CharLocationCopyWithImpl<$Res>
    implements _$CharLocationCopyWith<$Res> {
  __$CharLocationCopyWithImpl(this._self, this._then);

  final _CharLocation _self;
  final $Res Function(_CharLocation) _then;

/// Create a copy of CharLocation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? citedText = null,Object? documentIndex = freezed,}) {
  return _then(_CharLocation(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as String,citedText: null == citedText ? _self.citedText : citedText // ignore: cast_nullable_to_non_nullable
as String,documentIndex: freezed == documentIndex ? _self.documentIndex : documentIndex // ignore: cast_nullable_to_non_nullable
as int?,
...
/// @nodoc
mixin _$WebSearchResultItem {

/// The type of search result.
 String get type;/// The URL of the search result.
 String get url;/// The title of the search result.
 String get title;/// The encrypted content of the search result.
@JsonKey(name: 'encrypted_content', includeIfNull: false) String? get encryptedContent;/// The age or date of the page.
@JsonKey(name: 'page_age', includeIfNull: false) String? get pageAge;
/// Create a copy of WebSearchResultItem
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$WebSearchResultItemCopyWith<WebSearchResultItem> get copyWith => _$WebSearchResultItemCopyWithImpl<WebSearchResultItem>(this as WebSearchResultItem, _$identity);

  /// Serializes this WebSearchResultItem to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WebSearchResultItem&&(identical(other.type, type) || other.type == type)&&(identical(other.url, url) || other.url == url)&&(identical(other.title, title) || other.title == title)&&(identical(other.encryptedContent, encryptedContent) || other.encryptedContent == encryptedContent)&&(identical(other.pageAge, pageAge) || other.pageAge == pageAge));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,url,title,encryptedContent,pageAge);

@override
String toString() {
  return 'WebSearchResultItem(type: $type, url: $url, title: $title, encryptedContent: $encryptedContent, pageAge: $pageAge)';
}
...
/// @nodoc
abstract mixin class $WebSearchResultItemCopyWith<$Res>  {
  factory $WebSearchResultItemCopyWith(WebSearchResultItem value, $Res Function(WebSearchResultItem) _then) = _$WebSearchResultItemCopyWithImpl;
@useResult
$Res call({
 String type, String url, String title,@JsonKey(name: 'encrypted_content', includeIfNull: false) String? encryptedContent,@JsonKey(name: 'page_age', includeIfNull: false) String? pageAge
});
...
/// @nodoc
class _$WebSearchResultItemCopyWithImpl<$Res>
    implements $WebSearchResultItemCopyWith<$Res> {
  _$WebSearchResultItemCopyWithImpl(this._self, this._then);

  final WebSearchResultItem _self;
  final $Res Function(WebSearchResultItem) _then;

/// Create a copy of WebSearchResultItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? url = null,Object? title = null,Object? encryptedContent = freezed,Object? pageAge = freezed,}) {
  return _then(_self.copyWith(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as String,url: null == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,encryptedContent: freezed == encryptedContent ? _self.encryptedContent : encryptedContent // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [WebSearchResultItem].
extension WebSearchResultItemPatterns on WebSearchResultItem {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _WebSearchResultItem value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _WebSearchResultItem() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _WebSearchResultItem value)  $default,){
final _that = this;
switch (_that) {
case _WebSearchResultItem():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _WebSearchResultItem value)?  $default,){
final _that = this;
switch (_that) {
case _WebSearchResultItem() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String type,  String url,  String title, @JsonKey(name: 'encrypted_content', includeIfNull: false)  String? encryptedContent, @JsonKey(name: 'page_age', includeIfNull: false)  String? pageAge)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WebSearchResultItem() when $default != null:
return $default(_that.type,_that.url,_that.title,_that.encryptedContent,_that.pageAge);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String type,  String url,  String title, @JsonKey(name: 'encrypted_content', includeIfNull: false)  String? encryptedContent, @JsonKey(name: 'page_age', includeIfNull: false)  String? pageAge)  $default,) {final _that = this;
switch (_that) {
case _WebSearchResultItem():
return $default(_that.type,_that.url,_that.title,_that.encryptedContent,_that.pageAge);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String type,  String url,  String title, @JsonKey(name: 'encrypted_content', includeIfNull: false)  String? encryptedContent, @JsonKey(name: 'page_age', includeIfNull: false)  String? pageAge)?  $default,) {final _that = this;
switch (_that) {
case _WebSearchResultItem() when $default != null:
return $default(_that.type,_that.url,_that.title,_that.encryptedContent,_that.pageAge);case _:
  return null;
...
class _WebSearchResultItem extends WebSearchResultItem {
  const _WebSearchResultItem({required this.type, required this.url, required this.title, @JsonKey(name: 'encrypted_content', includeIfNull: false) this.encryptedContent, @JsonKey(name: 'page_age', includeIfNull: false) this.pageAge}): super._();
  factory _WebSearchResultItem.fromJson(Map<String, dynamic> json) => _$WebSearchResultItemFromJson(json);
...
@override@JsonKey(name: 'encrypted_content', includeIfNull: false) final  String? encryptedContent;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$WebSearchResultItemCopyWith<_WebSearchResultItem> get copyWith => __$WebSearchResultItemCopyWithImpl<_WebSearchResultItem>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$WebSearchResultItemToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WebSearchResultItem&&(identical(other.type, type) || other.type == type)&&(identical(other.url, url) || other.url == url)&&(identical(other.title, title) || other.title == title)&&(identical(other.encryptedContent, encryptedContent) || other.encryptedContent == encryptedContent)&&(identical(other.pageAge, pageAge) || other.pageAge == pageAge));
}
...
/// @nodoc
abstract mixin class _$WebSearchResultItemCopyWith<$Res> implements $WebSearchResultItemCopyWith<$Res> {
  factory _$WebSearchResultItemCopyWith(_WebSearchResultItem value, $Res Function(_WebSearchResultItem) _then) = __$WebSearchResultItemCopyWithImpl;
@override @useResult
$Res call({
 String type, String url, String title,@JsonKey(name: 'encrypted_content', includeIfNull: false) String? encryptedContent,@JsonKey(name: 'page_age', includeIfNull: false) String? pageAge
});
...
/// @nodoc
class __$WebSearchResultItemCopyWithImpl<$Res>
    implements _$WebSearchResultItemCopyWith<$Res> {
  __$WebSearchResultItemCopyWithImpl(this._self, this._then);

  final _WebSearchResultItem _self;
  final $Res Function(_WebSearchResultItem) _then;

/// Create a copy of WebSearchResultItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? url = null,Object? title = null,Object? encryptedContent = freezed,Object? pageAge = freezed,}) {
  return _then(_WebSearchResultItem(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as String,url: null == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,encryptedContent: freezed == encryptedContent ? _self.encryptedContent : encryptedContent // ignore: cast_nullable_to_non_nullable
...
/// @nodoc
mixin _$WebSearchResultLocation {

/// The type of citation.
 String get type;/// The URL of the cited source.
 String get url;/// The title of the cited source.
 String get title;/// The encrypted index identifier.
@JsonKey(name: 'encrypted_index') String get encryptedIndex;/// The text that was cited from this source.
@JsonKey(name: 'cited_text') String get citedText;
/// Create a copy of WebSearchResultLocation
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$WebSearchResultLocationCopyWith<WebSearchResultLocation> get copyWith => _$WebSearchResultLocationCopyWithImpl<WebSearchResultLocation>(this as WebSearchResultLocation, _$identity);

  /// Serializes this WebSearchResultLocation to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WebSearchResultLocation&&(identical(other.type, type) || other.type == type)&&(identical(other.url, url) || other.url == url)&&(identical(other.title, title) || other.title == title)&&(identical(other.encryptedIndex, encryptedIndex) || other.encryptedIndex == encryptedIndex)&&(identical(other.citedText, citedText) || other.citedText == citedText));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,url,title,encryptedIndex,citedText);

@override
String toString() {
  return 'WebSearchResultLocation(type: $type, url: $url, title: $title, encryptedIndex: $encryptedIndex, citedText: $citedText)';
}
...
/// @nodoc
abstract mixin class $WebSearchResultLocationCopyWith<$Res>  {
  factory $WebSearchResultLocationCopyWith(WebSearchResultLocation value, $Res Function(WebSearchResultLocation) _then) = _$WebSearchResultLocationCopyWithImpl;
@useResult
$Res call({
 String type, String url, String title,@JsonKey(name: 'encrypted_index') String encryptedIndex,@JsonKey(name: 'cited_text') String citedText
});
...
/// @nodoc
class _$WebSearchResultLocationCopyWithImpl<$Res>
    implements $WebSearchResultLocationCopyWith<$Res> {
  _$WebSearchResultLocationCopyWithImpl(this._self, this._then);

  final WebSearchResultLocation _self;
  final $Res Function(WebSearchResultLocation) _then;

/// Create a copy of WebSearchResultLocation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? url = null,Object? title = null,Object? encryptedIndex = null,Object? citedText = null,}) {
  return _then(_self.copyWith(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as String,url: null == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,encryptedIndex: null == encryptedIndex ? _self.encryptedIndex : encryptedIndex // ignore: cast_nullable_to_non_nullable
as String,citedText: null == citedText ? _self.citedText : citedText // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
/// Adds pattern-matching-related methods to [WebSearchResultLocation].
extension WebSearchResultLocationPatterns on WebSearchResultLocation {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _WebSearchResultLocation value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _WebSearchResultLocation() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _WebSearchResultLocation value)  $default,){
final _that = this;
switch (_that) {
case _WebSearchResultLocation():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _WebSearchResultLocation value)?  $default,){
final _that = this;
switch (_that) {
case _WebSearchResultLocation() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String type,  String url,  String title, @JsonKey(name: 'encrypted_index')  String encryptedIndex, @JsonKey(name: 'cited_text')  String citedText)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WebSearchResultLocation() when $default != null:
return $default(_that.type,_that.url,_that.title,_that.encryptedIndex,_that.citedText);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String type,  String url,  String title, @JsonKey(name: 'encrypted_index')  String encryptedIndex, @JsonKey(name: 'cited_text')  String citedText)  $default,) {final _that = this;
switch (_that) {
case _WebSearchResultLocation():
return $default(_that.type,_that.url,_that.title,_that.encryptedIndex,_that.citedText);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String type,  String url,  String title, @JsonKey(name: 'encrypted_index')  String encryptedIndex, @JsonKey(name: 'cited_text')  String citedText)?  $default,) {final _that = this;
switch (_that) {
case _WebSearchResultLocation() when $default != null:
return $default(_that.type,_that.url,_that.title,_that.encryptedIndex,_that.citedText);case _:
  return null;
...
class _WebSearchResultLocation extends WebSearchResultLocation {
  const _WebSearchResultLocation({required this.type, required this.url, required this.title, @JsonKey(name: 'encrypted_index') required this.encryptedIndex, @JsonKey(name: 'cited_text') required this.citedText}): super._();
  factory _WebSearchResultLocation.fromJson(Map<String, dynamic> json) => _$WebSearchResultLocationFromJson(json);
...
@override@JsonKey(name: 'encrypted_index') final  String encryptedIndex;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$WebSearchResultLocationCopyWith<_WebSearchResultLocation> get copyWith => __$WebSearchResultLocationCopyWithImpl<_WebSearchResultLocation>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$WebSearchResultLocationToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WebSearchResultLocation&&(identical(other.type, type) || other.type == type)&&(identical(other.url, url) || other.url == url)&&(identical(other.title, title) || other.title == title)&&(identical(other.encryptedIndex, encryptedIndex) || other.encryptedIndex == encryptedIndex)&&(identical(other.citedText, citedText) || other.citedText == citedText));
}
...
/// @nodoc
abstract mixin class _$WebSearchResultLocationCopyWith<$Res> implements $WebSearchResultLocationCopyWith<$Res> {
  factory _$WebSearchResultLocationCopyWith(_WebSearchResultLocation value, $Res Function(_WebSearchResultLocation) _then) = __$WebSearchResultLocationCopyWithImpl;
@override @useResult
$Res call({
 String type, String url, String title,@JsonKey(name: 'encrypted_index') String encryptedIndex,@JsonKey(name: 'cited_text') String citedText
});
...
/// @nodoc
class __$WebSearchResultLocationCopyWithImpl<$Res>
    implements _$WebSearchResultLocationCopyWith<$Res> {
  __$WebSearchResultLocationCopyWithImpl(this._self, this._then);

  final _WebSearchResultLocation _self;
  final $Res Function(_WebSearchResultLocation) _then;

/// Create a copy of WebSearchResultLocation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? url = null,Object? title = null,Object? encryptedIndex = null,Object? citedText = null,}) {
  return _then(_WebSearchResultLocation(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as String,url: null == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,encryptedIndex: null == encryptedIndex ? _self.encryptedIndex : encryptedIndex // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( ToolCustom value)?  custom,TResult? Function( ToolComputerUse value)?  computerUse,TResult? Function( ToolTextEditor value)?  textEditor,TResult? Function( ToolBash value)?  bash,TResult? Function( ToolWebSearch value)?  webSearch,}){
final _that = this;
switch (_that) {
case ToolCustom() when custom != null:
return custom(_that);case ToolComputerUse() when computerUse != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function(@JsonKey(includeIfNull: false)  String? type,  String name, @JsonKey(includeIfNull: false)  String? description, @JsonKey(name: 'input_schema')  Map<String, dynamic> inputSchema)?  custom,TResult Function( String type,  String name, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl, @JsonKey(name: 'display_width_px')  int displayWidthPx, @JsonKey(name: 'display_height_px')  int displayHeightPx, @JsonKey(name: 'display_number', includeIfNull: false)  int? displayNumber)?  computerUse,TResult Function( String type,  String name, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)?  textEditor,TResult Function( String type,  String name, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)?  bash,TResult Function( String type,  String name, @JsonKey(name: 'max_uses', includeIfNull: false)  int? maxUses, @JsonKey(name: 'allowed_domains', includeIfNull: false)  List<String>? allowedDomains, @JsonKey(name: 'blocked_domains', includeIfNull: false)  List<String>? blockedDomains, @JsonKey(name: 'user_location', includeIfNull: false)  ToolWebSearchUserLocation? userLocation, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)?  webSearch,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ToolCustom() when custom != null:
...
return webSearch(_that.type,_that.name,_that.maxUses,_that.allowedDomains,_that.blockedDomains,_that.userLocation,_that.cacheControl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function(@JsonKey(includeIfNull: false)  String? type,  String name, @JsonKey(includeIfNull: false)  String? description, @JsonKey(name: 'input_schema')  Map<String, dynamic> inputSchema)  custom,required TResult Function( String type,  String name, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl, @JsonKey(name: 'display_width_px')  int displayWidthPx, @JsonKey(name: 'display_height_px')  int displayHeightPx, @JsonKey(name: 'display_number', includeIfNull: false)  int? displayNumber)  computerUse,required TResult Function( String type,  String name, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)  textEditor,required TResult Function( String type,  String name, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)  bash,required TResult Function( String type,  String name, @JsonKey(name: 'max_uses', includeIfNull: false)  int? maxUses, @JsonKey(name: 'allowed_domains', includeIfNull: false)  List<String>? allowedDomains, @JsonKey(name: 'blocked_domains', includeIfNull: false)  List<String>? blockedDomains, @JsonKey(name: 'user_location', includeIfNull: false)  ToolWebSearchUserLocation? userLocation, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)  webSearch,}) {final _that = this;
switch (_that) {
case ToolCustom():
...
return webSearch(_that.type,_that.name,_that.maxUses,_that.allowedDomains,_that.blockedDomains,_that.userLocation,_that.cacheControl);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
class ToolWebSearch extends Tool {
  const ToolWebSearch({this.type = 'web_search_20250305', this.name = 'web_search', @JsonKey(name: 'max_uses', includeIfNull: false) this.maxUses, @JsonKey(name: 'allowed_domains', includeIfNull: false) final  List<String>? allowedDomains, @JsonKey(name: 'blocked_domains', includeIfNull: false) final  List<String>? blockedDomains, @JsonKey(name: 'user_location', includeIfNull: false) this.userLocation, @JsonKey(name: 'cache_control', includeIfNull: false) this.cacheControl}): _allowedDomains = allowedDomains,_blockedDomains = blockedDomains,super._();
...
@JsonKey(name: 'user_location', includeIfNull: false) final  ToolWebSearchUserLocation? userLocation;
/// The cache control settings.
@JsonKey(name: 'cache_control', includeIfNull: false) final  CacheControlEphemeral? cacheControl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,name,maxUses,const DeepCollectionEquality().hash(_allowedDomains),const DeepCollectionEquality().hash(_blockedDomains),userLocation,cacheControl);

@override
String toString() {
  return 'Tool.webSearch(type: $type, name: $name, maxUses: $maxUses, allowedDomains: $allowedDomains, blockedDomains: $blockedDomains, userLocation: $userLocation, cacheControl: $cacheControl)';
}
...
@override @useResult
$Res call({
 String type, String name,@JsonKey(name: 'max_uses', includeIfNull: false) int? maxUses,@JsonKey(name: 'allowed_domains', includeIfNull: false) List<String>? allowedDomains,@JsonKey(name: 'blocked_domains', includeIfNull: false) List<String>? blockedDomains,@JsonKey(name: 'user_location', includeIfNull: false) ToolWebSearchUserLocation? userLocation,@JsonKey(name: 'cache_control', includeIfNull: false) CacheControlEphemeral? cacheControl
});


$ToolWebSearchUserLocationCopyWith<$Res>? get userLocation;$CacheControlEphemeralCopyWith<$Res>? get cacheControl;
...
/// Create a copy of Tool
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? name = null,Object? maxUses = freezed,Object? allowedDomains = freezed,Object? blockedDomains = freezed,Object? userLocation = freezed,Object? cacheControl = freezed,}) {
...
as ToolWebSearchUserLocation?,cacheControl: freezed == cacheControl ? _self.cacheControl : cacheControl // ignore: cast_nullable_to_non_nullable
as CacheControlEphemeral?,
  ));
}
...
@override
@pragma('vm:prefer-inline')
$ToolWebSearchUserLocationCopyWith<$Res>? get userLocation {
    if (_self.userLocation == null) {
    return null;
  }

  return $ToolWebSearchUserLocationCopyWith<$Res>(_self.userLocation!, (value) {
...
/// @nodoc
mixin _$ToolWebSearchUserLocation {

/// The type of location specification.
 ToolWebSearchUserLocationType get type;/// The city name.
@JsonKey(includeIfNull: false) String? get city;/// The region or state name.
@JsonKey(includeIfNull: false) String? get region;/// The country code (e.g., "US").
@JsonKey(includeIfNull: false) String? get country;/// The timezone identifier (e.g., "America/Los_Angeles").
@JsonKey(includeIfNull: false) String? get timezone;
/// Create a copy of ToolWebSearchUserLocation
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ToolWebSearchUserLocationCopyWith<ToolWebSearchUserLocation> get copyWith => _$ToolWebSearchUserLocationCopyWithImpl<ToolWebSearchUserLocation>(this as ToolWebSearchUserLocation, _$identity);

  /// Serializes this ToolWebSearchUserLocation to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ToolWebSearchUserLocation&&(identical(other.type, type) || other.type == type)&&(identical(other.city, city) || other.city == city)&&(identical(other.region, region) || other.region == region)&&(identical(other.country, country) || other.country == country)&&(identical(other.timezone, timezone) || other.timezone == timezone));
}
...
@override
String toString() {
  return 'ToolWebSearchUserLocation(type: $type, city: $city, region: $region, country: $country, timezone: $timezone)';
}
...
/// @nodoc
abstract mixin class $ToolWebSearchUserLocationCopyWith<$Res>  {
  factory $ToolWebSearchUserLocationCopyWith(ToolWebSearchUserLocation value, $Res Function(ToolWebSearchUserLocation) _then) = _$ToolWebSearchUserLocationCopyWithImpl;
@useResult
$Res call({
 ToolWebSearchUserLocationType type,@JsonKey(includeIfNull: false) String? city,@JsonKey(includeIfNull: false) String? region,@JsonKey(includeIfNull: false) String? country,@JsonKey(includeIfNull: false) String? timezone
});
...
/// @nodoc
class _$ToolWebSearchUserLocationCopyWithImpl<$Res>
    implements $ToolWebSearchUserLocationCopyWith<$Res> {
  _$ToolWebSearchUserLocationCopyWithImpl(this._self, this._then);

  final ToolWebSearchUserLocation _self;
  final $Res Function(ToolWebSearchUserLocation) _then;
...
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? city = freezed,Object? region = freezed,Object? country = freezed,Object? timezone = freezed,}) {
  return _then(_self.copyWith(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as ToolWebSearchUserLocationType,city: freezed == city ? _self.city : city // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [ToolWebSearchUserLocation].
extension ToolWebSearchUserLocationPatterns on ToolWebSearchUserLocation {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ToolWebSearchUserLocation value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ToolWebSearchUserLocation() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ToolWebSearchUserLocation value)  $default,){
final _that = this;
switch (_that) {
case _ToolWebSearchUserLocation():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ToolWebSearchUserLocation value)?  $default,){
final _that = this;
switch (_that) {
case _ToolWebSearchUserLocation() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ToolWebSearchUserLocationType type, @JsonKey(includeIfNull: false)  String? city, @JsonKey(includeIfNull: false)  String? region, @JsonKey(includeIfNull: false)  String? country, @JsonKey(includeIfNull: false)  String? timezone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ToolWebSearchUserLocation() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ToolWebSearchUserLocationType type, @JsonKey(includeIfNull: false)  String? city, @JsonKey(includeIfNull: false)  String? region, @JsonKey(includeIfNull: false)  String? country, @JsonKey(includeIfNull: false)  String? timezone)  $default,) {final _that = this;
switch (_that) {
case _ToolWebSearchUserLocation():
return $default(_that.type,_that.city,_that.region,_that.country,_that.timezone);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ToolWebSearchUserLocationType type, @JsonKey(includeIfNull: false)  String? city, @JsonKey(includeIfNull: false)  String? region, @JsonKey(includeIfNull: false)  String? country, @JsonKey(includeIfNull: false)  String? timezone)?  $default,) {final _that = this;
switch (_that) {
case _ToolWebSearchUserLocation() when $default != null:
return $default(_that.type,_that.city,_that.region,_that.country,_that.timezone);case _:
  return null;
...
class _ToolWebSearchUserLocation extends ToolWebSearchUserLocation {
  const _ToolWebSearchUserLocation({required this.type, @JsonKey(includeIfNull: false) this.city, @JsonKey(includeIfNull: false) this.region, @JsonKey(includeIfNull: false) this.country, @JsonKey(includeIfNull: false) this.timezone}): super._();
  factory _ToolWebSearchUserLocation.fromJson(Map<String, dynamic> json) => _$ToolWebSearchUserLocationFromJson(json);

/// The type of location specification.
@override final  ToolWebSearchUserLocationType type;
/// The city name.
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$ToolWebSearchUserLocationCopyWith<_ToolWebSearchUserLocation> get copyWith => __$ToolWebSearchUserLocationCopyWithImpl<_ToolWebSearchUserLocation>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ToolWebSearchUserLocationToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ToolWebSearchUserLocation&&(identical(other.type, type) || other.type == type)&&(identical(other.city, city) || other.city == city)&&(identical(other.region, region) || other.region == region)&&(identical(other.country, country) || other.country == country)&&(identical(other.timezone, timezone) || other.timezone == timezone));
}
...
/// @nodoc
abstract mixin class _$ToolWebSearchUserLocationCopyWith<$Res> implements $ToolWebSearchUserLocationCopyWith<$Res> {
  factory _$ToolWebSearchUserLocationCopyWith(_ToolWebSearchUserLocation value, $Res Function(_ToolWebSearchUserLocation) _then) = __$ToolWebSearchUserLocationCopyWithImpl;
@override @useResult
$Res call({
 ToolWebSearchUserLocationType type,@JsonKey(includeIfNull: false) String? city,@JsonKey(includeIfNull: false) String? region,@JsonKey(includeIfNull: false) String? country,@JsonKey(includeIfNull: false) String? timezone
});
...
/// @nodoc
class __$ToolWebSearchUserLocationCopyWithImpl<$Res>
    implements _$ToolWebSearchUserLocationCopyWith<$Res> {
  __$ToolWebSearchUserLocationCopyWithImpl(this._self, this._then);

  final _ToolWebSearchUserLocation _self;
  final $Res Function(_ToolWebSearchUserLocation) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? city = freezed,Object? region = freezed,Object? country = freezed,Object? timezone = freezed,}) {
  return _then(_ToolWebSearchUserLocation(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as ToolWebSearchUserLocationType,city: freezed == city ? _self.city : city // ignore: cast_nullable_to_non_nullable
as String?,region: freezed == region ? _self.region : region // ignore: cast_nullable_to_non_nullable
as String?,country: freezed == country ? _self.country : country // ignore: cast_nullable_to_non_nullable
...
/// The type of content block.
 String get type;/// The cache control settings.
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Block&&(identical(other.type, type) || other.type == type)&&(identical(other.cacheControl, cacheControl) || other.cacheControl == cacheControl));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,cacheControl);
...
@useResult
$Res call({
 String type,@JsonKey(name: 'cache_control', includeIfNull: false) CacheControlEphemeral? cacheControl
});
...
/// Create a copy of Block
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? cacheControl = freezed,}) {
  return _then(_self.copyWith(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as String,cacheControl: freezed == cacheControl ? _self.cacheControl : cacheControl // ignore: cast_nullable_to_non_nullable
as CacheControlEphemeral?,
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( TextBlock value)?  text,TResult Function( ImageBlock value)?  image,TResult Function( ToolUseBlock value)?  toolUse,TResult Function( ToolResultBlock value)?  toolResult,TResult Function( ServerToolUseBlock value)?  serverToolUse,TResult Function( WebSearchToolResultBlock value)?  webSearchToolResult,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return toolResult(_that);case ServerToolUseBlock() when serverToolUse != null:
return serverToolUse(_that);case WebSearchToolResultBlock() when webSearchToolResult != null:
return webSearchToolResult(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( TextBlock value)  text,required TResult Function( ImageBlock value)  image,required TResult Function( ToolUseBlock value)  toolUse,required TResult Function( ToolResultBlock value)  toolResult,required TResult Function( ServerToolUseBlock value)  serverToolUse,required TResult Function( WebSearchToolResultBlock value)  webSearchToolResult,}){
final _that = this;
switch (_that) {
case TextBlock():
...
return toolResult(_that);case ServerToolUseBlock():
return serverToolUse(_that);case WebSearchToolResultBlock():
return webSearchToolResult(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( TextBlock value)?  text,TResult? Function( ImageBlock value)?  image,TResult? Function( ToolUseBlock value)?  toolUse,TResult? Function( ToolResultBlock value)?  toolResult,TResult? Function( ServerToolUseBlock value)?  serverToolUse,TResult? Function( WebSearchToolResultBlock value)?  webSearchToolResult,}){
final _that = this;
switch (_that) {
case TextBlock() when text != null:
return text(_that);case ImageBlock() when image != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String text,  String type, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl, @JsonKey(includeIfNull: false)  List<WebSearchResultLocation>? citations)?  text,TResult Function( ImageBlockSource source,  String type, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)?  image,TResult Function( String id,  String name,  Map<String, dynamic> input,  String type, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)?  toolUse,TResult Function(@JsonKey(name: 'tool_use_id')  String toolUseId, @_ToolResultBlockContentConverter()  ToolResultBlockContent content, @JsonKey(name: 'is_error', includeIfNull: false)  bool? isError,  String type, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)?  toolResult,TResult Function( String id,  String name,  Map<String, dynamic> input,  String type, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)?  serverToolUse,TResult Function( String type, @JsonKey(name: 'tool_use_id')  String toolUseId,  List<WebSearchResultItem> content, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)?  webSearchToolResult,required TResult orElse(),}) {final _that = this;
switch (_that) {
case TextBlock() when text != null:
return text(_that.text,_that.type,_that.cacheControl,_that.citations);case ImageBlock() when image != null:
...
return toolResult(_that.toolUseId,_that.content,_that.isError,_that.type,_that.cacheControl);case ServerToolUseBlock() when serverToolUse != null:
return serverToolUse(_that.id,_that.name,_that.input,_that.type,_that.cacheControl);case WebSearchToolResultBlock() when webSearchToolResult != null:
return webSearchToolResult(_that.type,_that.toolUseId,_that.content,_that.cacheControl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String text,  String type, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl, @JsonKey(includeIfNull: false)  List<WebSearchResultLocation>? citations)  text,required TResult Function( ImageBlockSource source,  String type, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)  image,required TResult Function( String id,  String name,  Map<String, dynamic> input,  String type, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)  toolUse,required TResult Function(@JsonKey(name: 'tool_use_id')  String toolUseId, @_ToolResultBlockContentConverter()  ToolResultBlockContent content, @JsonKey(name: 'is_error', includeIfNull: false)  bool? isError,  String type, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)  toolResult,required TResult Function( String id,  String name,  Map<String, dynamic> input,  String type, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)  serverToolUse,required TResult Function( String type, @JsonKey(name: 'tool_use_id')  String toolUseId,  List<WebSearchResultItem> content, @JsonKey(name: 'cache_control', includeIfNull: false)  CacheControlEphemeral? cacheControl)  webSearchToolResult,}) {final _that = this;
switch (_that) {
case TextBlock():
return text(_that.text,_that.type,_that.cacheControl,_that.citations);case ImageBlock():
...
return toolResult(_that.toolUseId,_that.content,_that.isError,_that.type,_that.cacheControl);case ServerToolUseBlock():
return serverToolUse(_that.id,_that.name,_that.input,_that.type,_that.cacheControl);case WebSearchToolResultBlock():
return webSearchToolResult(_that.type,_that.toolUseId,_that.content,_that.cacheControl);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
class TextBlock extends Block {
  const TextBlock({required this.text, this.type = 'text', @JsonKey(name: 'cache_control', includeIfNull: false) this.cacheControl, @JsonKey(includeIfNull: false) final  List<WebSearchResultLocation>? citations}): _citations = citations,super._();
...
/// Optional citations for the text content when using web search.
 final  List<WebSearchResultLocation>? _citations;
/// Optional citations for the text content when using web search.
@JsonKey(includeIfNull: false) List<WebSearchResultLocation>? get citations {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TextBlock&&(identical(other.text, text) || other.text == text)&&(identical(other.type, type) || other.type == type)&&(identical(other.cacheControl, cacheControl) || other.cacheControl == cacheControl)&&const DeepCollectionEquality().equals(other._citations, _citations));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,text,type,cacheControl,const DeepCollectionEquality().hash(_citations));

@override
String toString() {
  return 'Block.text(text: $text, type: $type, cacheControl: $cacheControl, citations: $citations)';
}
...
@override @useResult
$Res call({
 String text, String type,@JsonKey(name: 'cache_control', includeIfNull: false) CacheControlEphemeral? cacheControl,@JsonKey(includeIfNull: false) List<WebSearchResultLocation>? citations
});
...
/// Create a copy of Block
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? text = null,Object? type = null,Object? cacheControl = freezed,Object? citations = freezed,}) {
  return _then(TextBlock(
text: null == text ? _self.text : text // ignore: cast_nullable_to_non_nullable
as String,type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as String,cacheControl: freezed == cacheControl ? _self.cacheControl : cacheControl // ignore: cast_nullable_to_non_nullable
as CacheControlEphemeral?,citations: freezed == citations ? _self._citations : citations // ignore: cast_nullable_to_non_nullable
as List<WebSearchResultLocation>?,
  ));
}
...
class ServerToolUseBlock extends Block {
  const ServerToolUseBlock({required this.id, required this.name, required final  Map<String, dynamic> input, this.type = 'server_tool_use', @JsonKey(name: 'cache_control', includeIfNull: false) this.cacheControl}): _input = input,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ServerToolUseBlock&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._input, _input)&&(identical(other.type, type) || other.type == type)&&(identical(other.cacheControl, cacheControl) || other.cacheControl == cacheControl));
}
...
@override
String toString() {
  return 'Block.serverToolUse(id: $id, name: $name, input: $input, type: $type, cacheControl: $cacheControl)';
}
...
class WebSearchToolResultBlock extends Block {
  const WebSearchToolResultBlock({this.type = 'web_search_tool_result', @JsonKey(name: 'tool_use_id') required this.toolUseId, required final  List<WebSearchResultItem> content, @JsonKey(name: 'cache_control', includeIfNull: false) this.cacheControl}): _content = content,super._();
...
/// An array of web search results.
 final  List<WebSearchResultItem> _content;
/// An array of web search results.
 List<WebSearchResultItem> get content {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WebSearchToolResultBlock&&(identical(other.type, type) || other.type == type)&&(identical(other.toolUseId, toolUseId) || other.toolUseId == toolUseId)&&const DeepCollectionEquality().equals(other._content, _content)&&(identical(other.cacheControl, cacheControl) || other.cacheControl == cacheControl));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,toolUseId,const DeepCollectionEquality().hash(_content),cacheControl);

@override
String toString() {
  return 'Block.webSearchToolResult(type: $type, toolUseId: $toolUseId, content: $content, cacheControl: $cacheControl)';
}
...
@override @useResult
$Res call({
 String type,@JsonKey(name: 'tool_use_id') String toolUseId, List<WebSearchResultItem> content,@JsonKey(name: 'cache_control', includeIfNull: false) CacheControlEphemeral? cacheControl
});
...
/// Create a copy of Block
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? toolUseId = null,Object? content = null,Object? cacheControl = freezed,}) {
...
as List<WebSearchResultItem>,cacheControl: freezed == cacheControl ? _self.cacheControl : cacheControl // ignore: cast_nullable_to_non_nullable
as CacheControlEphemeral?,
  ));
}
...
/// A delta in a streaming message.
/// Any of: [TextBlockDelta], [InputJsonBlockDelta], [CitationsDelta]
...
BlockDelta _$BlockDeltaFromJson(
  Map<String, dynamic> json
        ...
        switch (json['type']) {
          ...
          return CitationsDelta.fromJson(
            json
          );
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BlockDeltaCopyWith<BlockDelta> get copyWith => _$BlockDeltaCopyWithImpl<BlockDelta>(this as BlockDelta, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BlockDelta&&(identical(other.type, type) || other.type == type));
}
...
/// @nodoc
abstract mixin class $BlockDeltaCopyWith<$Res>  {
  factory $BlockDeltaCopyWith(BlockDelta value, $Res Function(BlockDelta) _then) = _$BlockDeltaCopyWithImpl;
@useResult
$Res call({
 String type
});
...
/// @nodoc
class _$BlockDeltaCopyWithImpl<$Res>
    implements $BlockDeltaCopyWith<$Res> {
  _$BlockDeltaCopyWithImpl(this._self, this._then);

  final BlockDelta _self;
  final $Res Function(BlockDelta) _then;
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( TextBlockDelta value)?  textDelta,TResult Function( InputJsonBlockDelta value)?  inputJsonDelta,TResult Function( CitationsDelta value)?  citationsDelta,required TResult orElse(),}){
final _that = this;
switch (_that) {
case TextBlockDelta() when textDelta != null:
return textDelta(_that);case InputJsonBlockDelta() when inputJsonDelta != null:
return inputJsonDelta(_that);case CitationsDelta() when citationsDelta != null:
return citationsDelta(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( TextBlockDelta value)  textDelta,required TResult Function( InputJsonBlockDelta value)  inputJsonDelta,required TResult Function( CitationsDelta value)  citationsDelta,}){
final _that = this;
switch (_that) {
case TextBlockDelta():
return textDelta(_that);case InputJsonBlockDelta():
return inputJsonDelta(_that);case CitationsDelta():
return citationsDelta(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( TextBlockDelta value)?  textDelta,TResult? Function( InputJsonBlockDelta value)?  inputJsonDelta,TResult? Function( CitationsDelta value)?  citationsDelta,}){
final _that = this;
switch (_that) {
case TextBlockDelta() when textDelta != null:
return textDelta(_that);case InputJsonBlockDelta() when inputJsonDelta != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String text,  String type)?  textDelta,TResult Function(@JsonKey(name: 'partial_json', includeIfNull: false)  String? partialJson,  String type)?  inputJsonDelta,TResult Function( String type,  CharLocation citation)?  citationsDelta,required TResult orElse(),}) {final _that = this;
switch (_that) {
case TextBlockDelta() when textDelta != null:
return textDelta(_that.text,_that.type);case InputJsonBlockDelta() when inputJsonDelta != null:
return inputJsonDelta(_that.partialJson,_that.type);case CitationsDelta() when citationsDelta != null:
return citationsDelta(_that.type,_that.citation);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String text,  String type)  textDelta,required TResult Function(@JsonKey(name: 'partial_json', includeIfNull: false)  String? partialJson,  String type)  inputJsonDelta,required TResult Function( String type,  CharLocation citation)  citationsDelta,}) {final _that = this;
switch (_that) {
case TextBlockDelta():
return textDelta(_that.text,_that.type);case InputJsonBlockDelta():
return inputJsonDelta(_that.partialJson,_that.type);case CitationsDelta():
return citationsDelta(_that.type,_that.citation);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
/// Create a copy of BlockDelta
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? partialJson = freezed,Object? type = null,}) {
...
class CitationsDelta extends BlockDelta {
  const CitationsDelta({required this.type, required this.citation}): super._();
  factory CitationsDelta.fromJson(Map<String, dynamic> json) => _$CitationsDeltaFromJson(json);

/// The type of content block.
@override final  String type;
/// A character location reference within a document.
 final  CharLocation citation;

/// Create a copy of BlockDelta
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CitationsDeltaCopyWith<CitationsDelta> get copyWith => _$CitationsDeltaCopyWithImpl<CitationsDelta>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CitationsDeltaToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CitationsDelta&&(identical(other.type, type) || other.type == type)&&(identical(other.citation, citation) || other.citation == citation));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,citation);

@override
String toString() {
  return 'BlockDelta.citationsDelta(type: $type, citation: $citation)';
}
...
/// @nodoc
abstract mixin class $CitationsDeltaCopyWith<$Res> implements $BlockDeltaCopyWith<$Res> {
  factory $CitationsDeltaCopyWith(CitationsDelta value, $Res Function(CitationsDelta) _then) = _$CitationsDeltaCopyWithImpl;
@override @useResult
$Res call({
 String type, CharLocation citation
});


$CharLocationCopyWith<$Res> get citation;

}
/// @nodoc
class _$CitationsDeltaCopyWithImpl<$Res>
    implements $CitationsDeltaCopyWith<$Res> {
  _$CitationsDeltaCopyWithImpl(this._self, this._then);

  final CitationsDelta _self;
  final $Res Function(CitationsDelta) _then;

/// Create a copy of BlockDelta
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? citation = null,}) {
  return _then(CitationsDelta(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
...
$CharLocationCopyWith<$Res> get citation {
  ...
  return $CharLocationCopyWith<$Res>(_self.citation, (value) {
