...
ToolWebSearch _$ToolWebSearchFromJson(Map<String, dynamic> json) =>
    ToolWebSearch(
      ...
      name: json['name'] as String? ?? 'web_search',
      ...
      userLocation: json['user_location'] == null
          ? null
          : ToolWebSearchUserLocation.fromJson(
...
_ToolWebSearchUserLocation _$ToolWebSearchUserLocationFromJson(
  Map<String, dynamic> json,
) => _ToolWebSearchUserLocation(
  type: $enumDecode(_$ToolWebSearchUserLocationTypeEnumMap, json['type']),
...
Map<String, dynamic> _$ToolWebSearchUserLocationToJson(
  _ToolWebSearchUserLocation instance,
) => <String, dynamic>{
  'type': _$ToolWebSearchUserLocationTypeEnumMap[instance.type]!,
  'city': ?instance.city,
...
const _$ToolWebSearchUserLocationTypeEnumMap = {
  ToolWebSearchUserLocationType.approximate: 'approximate',
};
...
ServerToolUseBlock _$ServerToolUseBlockFromJson(Map<String, dynamic> json) =>
    ServerToolUseBlock(
      ...
      name: json['name'] as String,
      input: json['input'] as Map<String, dynamic>,
      type: json['type'] as String? ?? 'server_tool_use',
      cacheControl: json['cache_control'] == null
          ? null
          : CacheControlEphemeral.fromJson(
              json['cache_control'] as Map<String, dynamic>,
